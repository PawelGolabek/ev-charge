...
async function getPreset(devServerConfig) {
    switch (devServerConfig.framework) {
        ...
        default:
            throw new Error(`Unexpected framework ${devServerConfig.framework}, please visit https://docs.cypress.io/guides/component-testing/component-framework-configuration to see a list of supported frameworks`);
    }
}
/**
